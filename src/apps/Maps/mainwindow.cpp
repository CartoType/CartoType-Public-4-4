...
MainWindow::MainWindow(QWidget *parent) :
    ...
    // Strip the path down to a string ending with /src/; if no such pattern is found, use the app path
    m_cartotype_source_path = m_app_path;
    int n = m_cartotype_source_path.lastIndexOf("/src/");
    if (n != -1)
        m_cartotype_source_path.truncate(n + strlen("/src/"));
...
void MainWindow::on_actionAbout_CartoType_Maps_triggered()
    {
    QMessageBox::about(this,"About CartoType Maps","The <b>CartoType Maps</b> app allows you to view maps, calculate routes, find places, and more.<br/><br/>"
                            "See <a href='http://www.cartotype.com'>cartotype.com</a> for information about creating maps, using the API, and licensing CartoType for your application.");
    }
