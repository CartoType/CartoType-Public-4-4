...
class CVectorTileHelper
    ...
    */
    ...
    A 3D transform is used so that non-affine transformations for perspective mode work. The z
    coordinate of transformed points can always be ignored.
    */
    virtual void Draw(const CVectorTileDrawData& aDrawData,const TTransform3FP& aTransform) = 0;
...
class CSoftwareVectorTileHelper: public CVectorTileHelper
    ...
    void Draw(const CVectorTileDrawData& aDrawData,const TTransform3FP& aTransform) override;
