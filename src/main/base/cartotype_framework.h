...
class CFramework: public MNavigatorObserver
    ...
    */
    ...
    void UseVectorTileServer(bool aEnable);
    ...
    static constexpr uint32 KMapBitmapValid = 1;
    static constexpr uint32 KMemoryMapBitmapValid = 2;
    static constexpr uint32 KWebMapServiceBitmapValid = 4;
