...
class MString
    ...
    */
    ...
    int32 Compare(const MString& aString,bool aFoldCase) const;
    int32 Compare(const MString& aString,TStringMatchMethod aStringMatchMethod) const;
    size_t Find(const MString& aString,TStringMatchMethod aStringMatchMethod = TStringMatchMethod::Exact,size_t* aEndPos = nullptr) const;
    ...
    int32 Compare(const uint16* aText,size_t aLength,bool aFoldCase) const;
    ...
    */
    ...
    static void ToInt32(const uint8* aText,size_t aLength,int32& aValue,size_t& aLengthUsed,int32 aBase = 10);
    void ToInt32(int32& aValue,size_t& aLengthUsed,int32 aBase = 10) const;
    void ToInt64(int64& aValue,size_t& aLengthUsed,int32 aBase = 10) const;
    void ToUint32(uint32& aValue,size_t& aLengthUsed,int32 aBase = 10) const;
