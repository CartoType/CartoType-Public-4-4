...
BOOL CCartoTypeDemoView::OnMouseWheel(UINT nFlags,short zDelta,CPoint point)
    ...
    if (point.x >= r.left && point.x < r.right && point.y >= r.top && point.y <= r.bottom)
        ...
        iFramework->ConvertPoint(p,CartoType::TCoordType::Display,CartoType::TCoordType::Map);
        set_centre = true;
        }
    ...
    */
    ...
    if (set_centre)
        iFramework->Pan(p.iX,p.iY,CartoType::TCoordType::Map,point.x,point.y,CartoType::TCoordType::Display);
